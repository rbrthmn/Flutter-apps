...
import 'package:fluttershopadmin/tabs/orders_tab.dart';
import 'package:fluttershopadmin/tabs/products_tab.dart';
        ...
        return SpeedDial(
          ...
          children: [
            SpeedDialChild(
                ...
                onTap: () {
                  _ordersBloc.setOrderCriteri(SortCriteria.READY_LAST);
                }),
            SpeedDialChild(
                ...
                labelStyle: TextStyle(fontSize: 14),
                onTap: () {
                  _ordersBloc.setOrderCriteri(SortCriteria.READY_FIRST);
                })
          ],
        );
      case 2:
